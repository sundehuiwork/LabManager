$(function() {
	...
	function d() {
		...
		if (!$(this).hasClass("active")) {
			...
			$(".J_mainContent .J_iframe").each(function() {
				 var a=$(this).data("id") == t ? ($(this).show().siblings(".J_iframe").hide(), !1) : void 0;
				 return a;
	...
	, $(".J_menuItem").on("click", n), $(".J_menuTabs").on("click", ".J_menuTab i", s), $(".J_tabCloseOther").on("click", r), $(".J_tabShowActive").on("click", o), $(".J_menuTabs").on("click", ".J_menuTab", d), $(".J_menuTabs").on("dblclick", ".J_menuTab", c), $(".J_tabLeft").on("click", a), $(".J_tabRight").on("click", i)
