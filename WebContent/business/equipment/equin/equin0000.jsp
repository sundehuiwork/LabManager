						...
						<form class="form-horizontal" id="frmQry">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="type" class="form-control m-b" >
								    	<option value='' > 请选择...</option>
										<option value='1' ${frmQry.type=='1'?'selected':''}>实验室一</option>
										<option value='2' ${frmQry.type=='2'?'selected':''}>实验室二</option>
										<option value='3' ${frmQry.type=='3'?'selected':''}>实验室三</option>
										<option value='4' ${frmQry.type=='4'?'selected':''}>实验室四</option>
										<option value='5' ${frmQry.type=='5'?'selected':''}>实验室五</option>
									</select>
								</div>
							</div>
							<div class="row-fluid">
