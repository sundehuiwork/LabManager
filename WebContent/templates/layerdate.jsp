                                    ...
                                    <div class="panel-group" id="accordion">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                ...
                                                <span class="label label-info">1</span> <a data-toggle="collapse" data-parent="#accordion" href="tabs_panels.jsp#collapseOne">核心方法：<code>aydate(options)</code></a>
                                            </h5>
                                            </div>
...
choose: function(dates){ //选择好日期的回调
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                ...
                                                <a data-toggle="collapse" data-parent="#accordion" href="tabs_panels.jsp#collapseTwo">其它方法/属性</a>
                                            </h4>
                                            </div>
...
laydate.reset();    //重设日历控件坐标，一般用于页面dom结构改变时。无参</pre>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/layer/laydate/laydate.js"></script>
    <script>
