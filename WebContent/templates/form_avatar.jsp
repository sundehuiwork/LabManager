...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="m-t m-b">
                            ...
                            <div id="userAlbums" style="display:none">
                                <a href="${pageContext.request.contextPath}/assets/img/a1.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a1.jpg" alt="示例图片1" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a2.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a2.jpg" alt="示例图片2" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a3.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a3.jpg" alt="示例图片2" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a4.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a4.jpg" alt="示例图片2" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a5.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a5.jpg" alt="示例图片2" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a6.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a6.jpg" alt="示例图片2" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a7.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a7.jpg" alt="示例图片2" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a8.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a8.jpg" alt="示例图片2" />
                                </a>
                                <a href="${pageContext.request.contextPath}/assets/img/a9.jpg" class="fancybox" title="选取该照片">
                                    <img src="${pageContext.request.contextPath}/assets/img/a9.jpg" alt="示例图片2" />
                                </a>>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/plugins/fullavatareditor/scripts/swfobject.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/plugins/fullavatareditor/scripts/fullAvatarEditor.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/plugins/fullavatareditor/scripts/jQuery.Cookie.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/plugins/fullavatareditor/scripts/test.js"></script>
