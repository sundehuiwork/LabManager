...
<head>
    ...
    <!-- jqgrid-->
    <link href="${pageContext.request.contextPath}/assets/css/plugins/jqgrid/ui.jqgrid.css?0820" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/jqgrid/i18n/grid.locale-cn.js?0820"></script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/jqgrid/jquery.jqGrid.min.js?0820"></script>
