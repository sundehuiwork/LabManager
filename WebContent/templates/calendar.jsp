...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assets/css/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="calendar.jsp#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="calendar.jsp#">选项1</a>
                                </li>
                                <li><a href="calendar.jsp#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/fullcalendar/fullcalendar.min.js"></script>
    <script>
