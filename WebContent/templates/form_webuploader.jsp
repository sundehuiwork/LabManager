...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/demo/webuploader-demo.min.css">
...
<body class="gray-bg">
    ...
    <script type="text/javascript">
        var BASE_URL = '${pageContext.request.contextPath}/assets/js/plugins/webuploader';
    </script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/webuploader/webuploader.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/demo/webuploader-demo.min.js"></script>
