...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="widget-head-color-box navy-bg p-lg text-center">
                    ...
                    <img src="${pageContext.request.contextPath}/assets/img/a4.jpg" class="img-circle circle-border m-b-md" alt="profile">
                    <div>
                        <span>100 动态</span> |
                        <span>350 关注</span> |
                        <span>610 关注者</span>
                        ...
                        <div>
                            <div class="chat-activity-list">
                                ...
                                <div class="chat-element">
                                    <a href="widgets.jsp#" class="pull-left">
                                ...
                                <div class="chat-element right">
                                    <a href="widgets.jsp#" class="pull-right">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="ibox-content text-center">
                                <h1>奔波儿灞</h1>
                                <div class="m-b-sm">
                                    <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a8.jpg">
                                </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        ...
                        <ul class="todo-list m-t small-list">
                            <li>
                                <a href="widgets.jsp#" class="check-link"><i class="fa fa-check-square"></i> </a>
                            ...
                            <li>
                                <a href="widgets.jsp#" class="check-link"><i class="fa fa-square-o"></i> </a>
                                <span class="m-l-xs">修改bug</span>
                                <small class="label label-primary"><i class="fa fa-clock-o"></i> 1小时</small>
                            </li>
                        </ul>
        ...
        <div class="row m-t-lg">
            <div class="col-sm-12">
                <div class="ibox-content">
                    <h2>世界地图</h2>
                    <small>中国地图或者省份地图可使用百度前端团队提供的echarts.js。<a href="graph_echarts.jsp">百度ECharts</a></small>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/jquery-ui-1.10.4.min.js"></script>
