...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="buttons.jsp#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="buttons.jsp#">选项1</a>
                                </li>
                                <li><a href="buttons.jsp#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
    ...
    keyEnter: 13                    //回车键
                            ...
                            <p>请参考 index.jsp 文件源代码，提供了自定义数据、URL 请求数据、百度搜索API、淘宝搜索API的接口演示。</p>
