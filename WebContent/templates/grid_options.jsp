                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="grid_options.jsp#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="grid_options.jsp#">选项1</a>
                                </li>
                                <li><a href="grid_options.jsp#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <p>在等宽的4网格中，网格不等高会碰到问题，为了解决这个问题，可使用<code>.clearfix</code>。<a href="grid_options.jsp#responsive-utilities">响应实用工具类</a>
                        </p>
                        <div class="row show-grid">
