                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="project-people">
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a3.jpg"></a>
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a1.jpg"></a>
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a2.jpg"></a>
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a4.jpg"></a>
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a5.jpg"></a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-people">
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a7.jpg"></a>
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a6.jpg"></a>
                                            <a href="projects.jsp"><img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a3.jpg"></a>
                                        </td>
                                        <td class="project-actions">
                                            <a href="projects.jsp#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
