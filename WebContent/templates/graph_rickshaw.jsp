...
<body class="gray-bg">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/rickshaw/vendor/d3.v3.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/rickshaw/rickshaw.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/content.min.js?v=1.0.0"></script>
    <script src="${pageContext.request.contextPath}/assets/js/demo/rickshaw-demo.min.js"></script>
