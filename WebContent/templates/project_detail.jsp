    ...
    <div class="row">
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="m-b-md">
                                    <a href="project_detail.jsp#" class="btn btn-white btn-xs pull-right">编辑项目</a>
                                    <h2>阿里巴巴集团</h2>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>162</dd>
                                    <dt>客户：</dt>
                                    <dd><a href="project_detail.jsp#" class="text-navy"> 百度</a>
                                    </dd>
                                    <dt>版本：</dt>
                                    <dd>v1.4.2</dd>
                                </dl>
                                ...
                                <dl class="dl-horizontal">
                                    ...
                                    <dd class="project-people">
                                        <a href="project_detail.jsp">
                                            <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a3.jpg">
                                        </a>
                                        <a href="project_detail.jsp">
                                            <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a1.jpg">
                                        </a>
                                        <a href="project_detail.jsp">
                                            <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a2.jpg">
                                        </a>
                                        <a href="project_detail.jsp">
                                            <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a4.jpg">
                                        </a>
                                        <a href="project_detail.jsp">
                                            <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a5.jpg">
                                        </a>
                                    </dd>
                                </dl>
                            </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-1">
                                                <div class="feed-activity-list">
                                                    ...
                                                    <div class="feed-element">
                                                        <a href="profile.jsp#" class="pull-left">
                                                            <img alt="image" class="img-circle" src="${pageContext.request.contextPath}/assets/img/profile.jpg">
                                                        </a>
                                                        <div class="media-body ">
                                                        ...
                                                        <div class="media-body ">
                                                            ...
                                                            <div class="photos">
                                                                <a target="_blank" href="http://24.media.tumblr.com/20a9c501846f50c1271210639987000f/tumblr_n4vje69pJm1st5lhmo1_1280.jpg">
                                                                    <img alt="image" class="feed-photo" src="${pageContext.request.contextPath}/assets/img/p1.jpg">
                                                                </a>
                                                                <a target="_blank" href="http://37.media.tumblr.com/9afe602b3e624aff6681b0b51f5a062b/tumblr_n4ef69szs71st5lhmo1_1280.jpg">
                                                                    <img alt="image" class="feed-photo" src="${pageContext.request.contextPath}/assets/img/p3.jpg">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <div class="col-sm-3">
            <div class="wrapper wrapper-content project-manager">
                <h4>项目描述</h4>
                <img src="${pageContext.request.contextPath}/assets/img/wenku_logo.png" class="img-responsive">
                <p class="small">
                ...
                <ul class="tag-list" style="padding: 0">
                    <li><a href="project_detail.jsp"><i class="fa fa-tag"></i> 文档</a>
                    </li>
                    <li><a href="project_detail.jsp"><i class="fa fa-tag"></i> 分享</a>
                    </li>
                    <li><a href="project_detail.jsp"><i class="fa fa-tag"></i> 下载</a>
                    </li>
                </ul>
                <h5>项目文档</h5>
                <ul class="list-unstyled project-files">
                    <li><a href="project_detail.jsp"><i class="fa fa-file"></i> Project_document.docx</a>
                    </li>
                    <li><a href="project_detail.jsp"><i class="fa fa-file-picture-o"></i> Logo_zender_company.jpg</a>
                    </li>
                    <li><a href="project_detail.jsp"><i class="fa fa-stack-exchange"></i> Email_from_Alex.mln</a>
                    </li>
                    <li><a href="project_detail.jsp"><i class="fa fa-file"></i> Contract_20_11_2014.docx</a>
                    </li>
                </ul>
                <div class="m-t-md">
                    <a href="project_detail.jsp#" class="btn btn-xs btn-primary">添加文档</a>
