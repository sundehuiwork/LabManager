...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/plugins/blueimp/css/blueimp-gallery.min.css" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="lightBoxGallery">
                            <a href="${pageContext.request.contextPath}/assets/img/p_big1.jpg" title="图片" data-gallery=""><img src="${pageContext.request.contextPath}/assets/img/p1.jpg"></a>
                            <a href="${pageContext.request.contextPath}/assets/img/p_big2.jpg" title="图片" data-gallery=""><img src="${pageContext.request.contextPath}/assets/img/p2.jpg"></a>
                            <a href="${pageContext.request.contextPath}/assets/img/p_big3.jpg" title="图片" data-gallery=""><img src="${pageContext.request.contextPath}/assets/img/p3.jpg"></a>
                            <a href="${pageContext.request.contextPath}/assets/img/p_big1.jpg" title="图片" data-gallery=""><img src="${pageContext.request.contextPath}/assets/img/p1.jpg"></a>
                            <a href="${pageContext.request.contextPath}/assets/img/p_big2.jpg" title="图片" data-gallery=""><img src="${pageContext.request.contextPath}/assets/img/p2.jpg"></a>
                            <a href="${pageContext.request.contextPath}/assets/img/p_big3.jpg" title="图片" data-gallery=""><img src="${pageContext.request.contextPath}/assets/img/p3.jpg"></a>
                            <a href="${pageContext.request.contextPath}/assets/img/p_big1.jpg" title="图片" data-gallery=""><img src="${pageContext.request.contextPath}/assets/img/p1.jpg"></a>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/blueimp/jquery.blueimp-gallery.min.js"></script>
