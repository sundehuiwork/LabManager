...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/plugins/colorpicker/${pageContext.request.contextPath}/assets/css/bootstrap-colorpicker.min.css" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="form_advanced.jsp#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="form_advanced.jsp#">选项1</a>
                                </li>
                                <li><a href="form_advanced.jsp#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
            ...
            <div class="col-sm-7">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal m-t-md" action="form_advanced.jsp#">
                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-crop">
                                    <img src="${pageContext.request.contextPath}/assets/img/a3.jpg">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h4>图片预览：</h4>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/demo/form-advanced-demo.min.js"></script>
