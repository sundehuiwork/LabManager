                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <p>layer官网：<a href="http://layer.layui.com/" target="_blank">http://layer.layui.com/</a>
                            <br>layer官网文档：<a href="http://layer.layui.com/api.jsp" target="_blank">http://layer.layui.com/api.jsp</a>
                        </p>
                    </div>
                </div>
            </div>
...
parent.layer.alert('内容', {
    icon: 1,
    skin: 'layer-ext-moon' //该皮肤由layer.seaning.com友情扩展。关于皮肤的扩展规则，<a target="_balnk" style="color:#00B2E2;" href="http://layer.layui.com/skin.jsp#publish">去这里查阅</a>
})</p>
<p>//询问框
...
<p>//相册层
$.getJSON('${pageContext.request.contextPath}/assets/js/demo/photos.json', function(json){
    layer.photos({
    ...
    <script src="${pageContext.request.contextPath}/assets/js/demo/layer-demo.min.js"></script>
