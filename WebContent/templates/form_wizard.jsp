...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/plugins/steps/jquery.steps.css" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="form_wizard.jsp#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="form_wizard.jsp#">选项1</a>
                                </li>
                                <li><a href="form_wizard.jsp#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
            ...
            <div class="col-sm-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <form id="form" action="form_wizard.jsp#" class="wizard-big">
                            <h1>账户</h1>
                            <fieldset>
                                <h2>账户信息</h2>
                                <div class="row">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/staps/jquery.steps.min.js"></script>
