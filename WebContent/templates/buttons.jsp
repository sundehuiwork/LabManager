                        ...
                        <div class="ibox-content">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="buttons.jsp#">置顶</a>
                                    </li>
                                    <li><a href="buttons.jsp#" class="font-bold">修改</a>
                                    </li>
                                    <li><a href="buttons.jsp#">禁用</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li><a href="buttons.jsp#">删除</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="btn-group">
                ...
                <div class="col-sm-6">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <h3 class="font-bold">按钮组</h3>
                            <p>
                                <a class="btn btn-default btn-rounded" href="buttons.jsp#">默认</a>
                                <a class="btn btn-primary btn-rounded" href="buttons.jsp#">主要</a>
                                <a class="btn btn-success btn-rounded" href="buttons.jsp#">成果</a>
                                <a class="btn btn-info btn-rounded" href="buttons.jsp#">信息</a>
                                <a class="btn btn-warning btn-rounded" href="buttons.jsp#">警告</a>
                                <a class="btn btn-danger btn-rounded" href="buttons.jsp#">危险</a>
                                <a class="btn btn-danger btn-rounded btn-outline" href="buttons.jsp#">危险</a>
                                <br/>
                                <br/>
                                <a class="btn btn-primary btn-rounded btn-block" href="buttons.jsp#"><i class="fa fa-info-circle"></i> 圆角块级带图标按钮</a>
                            </p>
                        </div>
                    </div>
                </div>
