...
<body class="gray-bg">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/echarts/echarts-all.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/content.min.js?v=1.0.0"></script>
    <script src="${pageContext.request.contextPath}/assets/js/demo/echarts-demo.min.js"></script>
