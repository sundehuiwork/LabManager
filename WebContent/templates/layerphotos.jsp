            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content layer-photos-demo" id="layer-photos-demo">
                        ...
                        <a href="#" title="图片1">
                            <img alt="image" src="${pageContext.request.contextPath}/assets/img/p1.jpg" />
                        </a>

                        <a href="#" title="图片2">
                            <img alt="image" src="${pageContext.request.contextPath}/assets/img/p2.jpg" />
                        </a>
                        <a href="#" title="图片3">
                            <img alt="image" src="${pageContext.request.contextPath}/assets/img/p3.jpg" />
                        </a>
                        <a href="#" title="图片4">
                            <img alt="image" src="${pageContext.request.contextPath}/assets/img/p1.jpg" />
                        </a>
