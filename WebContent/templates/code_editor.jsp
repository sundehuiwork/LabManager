...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/plugins/codemirror/codemirror.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assets/css/plugins/codemirror/ambiance.css" rel="stylesheet">
...
function VoiceCtrl($scope) {
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/codemirror/codemirror.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/codemirror/mode/javascript/javascript.js"></script>
