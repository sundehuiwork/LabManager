        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="team-members">
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a1.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a2.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a3.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a5.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a6.jpg">
                            </a>
                        </div>
                        <h4>部门简介</h4>
                        <p>
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="team-members">
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a4.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a5.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a6.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a8.jpg">
                            </a>
                            <a href="#"><img alt="member" class="img-circle" src="${pageContext.request.contextPath}/assets/img/a7.jpg">
                            </a>
                        </div>
                        <h4>部门简介</h4>
                        <p>
