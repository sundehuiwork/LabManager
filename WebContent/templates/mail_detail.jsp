                            ...
                            <div class="file-box">
                                <div class="file">
                                    <a href="mail_detail.jsp#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive" src="${pageContext.request.contextPath}/assets/img/p1.jpg">
                                        </div>
                                        <div class="file-name">
                                            Italy street.jpg
                                        </div>
                            ...
                            <div class="file-box">
                                <div class="file">
                                    <a href="mail_detail.jsp#">
                                        ...
                                        <div class="image">
                                            <img alt="image" class="img-responsive" src="${pageContext.request.contextPath}/assets/img/p2.jpg">
                                        </div>
                                        <div class="file-name">
                                            My feel.png
                                        </div>
