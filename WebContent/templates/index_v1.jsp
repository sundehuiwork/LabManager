...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="${pageContext.request.contextPath}/assets/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/content.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/welcome.min.js"></script>
</body>
